...
<template>
  <div class="container" style="text-align: center; background: #322e2e; padding-top: 10px;">
    ...
    <hr>
    <div v-for="role of roles" class="row" style="margin-right: 0px; margin-left: 0px; margin-top: 5px" :key="role.id">
    ...
    <hr>
    <div v-for="user of users" class="row" style="margin-right: 0px; margin-left: 0px; margin-top: 2px; margin-block-end: 2px;" :key="user.user.id">
