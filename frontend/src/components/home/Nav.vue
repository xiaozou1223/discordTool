            ...
            <div class="collapse navbar-collapse text-center" id="navcol-1">
                ...
                <div class="container">
                    <div class="row navbar-links">
                        <div class="col-md-3"><a  v-if="user.isTokenValid" role="button" style="font-size: 22px;color: rgb(255,255,255);font-weight: bold;"  @click="router.push({ name: 'DiscordServer' })">伺服器</a></div>
                        <div class="col-md-3"><a v-if="user.isTokenValid" role="button" style="font-size: 22px;color: rgb(255,255,255);font-weight: bold;"  @click="router.push({ name: 'User' })">監聽中</a></div>
                        <div class="col-md-3"><a role="button" style="font-size: 22px;color: rgb(255,255,255);font-weight: bold;"  @click="router.push({ name: 'User' })">帳號設定</a></div>
